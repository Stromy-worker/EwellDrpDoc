...
![image](..\Resource\pic\nonTomcatCollect.png)
- [x] 表示已经经过排查
![image](..\Resource\pic\ExistTomcatCollect.png)
---
# 解决办法
...
```
![image](..Resource\pic\collectContainer.png)
...
```
![image](..Resource\pic\findCollectWar.png)
...
4. 访问tomcatcollect的包管理网址,确认collect程序包正常运行(识别红框部分均是true)
        ...
        登录信息从部署文档中获取
  ![image](..Resource\pic\collectStart.png)
5. 访问tomcat的包管理网址，删除采集的运行包

        http://[应用服务器ip]:8080/manager/html
        登录信息从部署文档中获取
![image](..Resource\pic\undeploy.png)
